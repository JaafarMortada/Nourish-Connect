...
const SignUpPage = () => {
    ...
    return (
        <div className="flex w-[100vw] ss:py-0 py-5 min-h-[100vh] md:flex-row flex-col overflow-scroll">
            ...
            <div className={`h-[100vh] flex-1 ss:flex hidden flex-col md:mt-0 mt-20 justify-center items-center`}>
                <img
