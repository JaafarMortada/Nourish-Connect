...
Route::group(["middleware" => "manager", "prefix" => "/manager"], function () {
    ...
    Route::post("approve_discount/{suggestion_id}", [DiscountsController::class, "approveDiscount"]);
    ...
    Route::get("approve_donation/{suggestion_id}", [DonationController::class, "approveDonation"]);
